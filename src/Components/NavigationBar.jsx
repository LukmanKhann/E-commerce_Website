  ...
  return (
    <div>
      <nav className={style.navbar}>
        <div id={style.logo}> <img src={mainimage} alt="" /> <input type="text" placeholder="search for products, brand and more" /> <button><i class="fa-solid fa-magnifying-glass"></i></button></div>
